...
const Menu = () => {
  ...
  const coffeeItems = [
    ...
    },
    {
      image: cappuccino,
      title: 'Cappuccino',
      description: 'A rich, bold Cappuccino topped with silky steamed milk and a light layer of foam.',
      price: '$4.50',
    },
    {
      image: americano,
      title: 'Americano',
      description: 'Fresh espresso diluted with hot water for a smooth, bold, and less intense brew.',
      price: '$3.00',
    },
  ];
  ...
  const breakfastItems = [
    {
      image: avocado,
      title: 'Avocado Toast',
      description: 'Toasted artisan bread topped with smashed avocado, sea salt, chili flakes, and a drizzle of olive oil.',
      price: '$6.50',
    },
    {
  ...
  return (
    <section id="menu" className="bg-gradient-to-b from-slate-50 to-blue-50 py-16 clip-menu">
      <div className="container mx-auto px-4">
        ...
        {menuSections.map((section, idx) => (
          <div key={idx} id={section.id} className="mb-12">
            <h3 className="text-2xl font-semibold text-coffee-700 mb-6">{section.title}</h3>
            ...
            {/* Divider */}
            {idx !== menuSections.length - 1 && <hr className="my-12 border-blue-200/50" />}
          </div>
        ))}
      </div>
    </section>
